...
public class ControllerAbstract implements InterfaceController {
  ...
  public Pair<ReadOnlyBlock, List<ReadOnlyPruefung>> scheduleBlock(ReadOnlyBlock block,
      LocalDateTime start) throws HartesKriteriumException, NoPruefungsPeriodeDefinedException {
    return null;
  }
  ...
  @Override
  public Pair<ReadOnlyBlock, ReadOnlyPruefung> removePruefungFromBlock(ReadOnlyBlock block,
